    ...
    <div class="row tile_count">
          ...
          <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                        <h2>Listado de los Comercios que se encuentran disponibles y habilitadas</h2>
                    ...
                    <div class="x_content">
                        <p class="text-muted font-13 m-b-30">
                            Lista de comercios que se encuentren habilitados en nuestra plataforma
                             para el usuario <b>{{Auth::user()->name}} {{Auth::user()->last_name}}</b>. 
                        </p>
                      <p>
                        <h4>Exportar la lista de Comercios</h4>
                      </p>
          
                   <div class="table-responsive">
                  <!--   <table id="transactions" class="table table-striped table-bordered">-->
                     <table id="customers" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                              <th nowrap>ID</th>
                              <th nowrap>NOMBRE</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$customer->customer_admin}}</td>
                                <td>{{$customer->created_at}}</td>
                                <td>{{$customer->user_creator}}</td>
                            </tr>
                          @endforeach
                        @endif     
                          </tbody>
