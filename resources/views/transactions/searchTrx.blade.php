...
<div class="right_col" role="main">
    ...
    <div class="row"> 
        ...
        {{ Form::open(array('id'=>'searchTrx','class' => 'form-group' , 'action' => 'TransactionController@index')) }}
        ...
        <button class="btn btn-default btn-primary" style="margin-top:23px;" type="submit" >Buscar</button>
        </div>
