    ...
    <div class="row"> 
        ...
        @include('layouts.partials.requestErrors')
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" >
                ...
                {{ Form::open(array('id' => 'searchTrxId', 'class' => 'form-group' , 'action' => 'TransactionController@searchTrxReaderBranch')) }}
                ...
                <div class="form-group col-md-6 ">
                  ...
                  <select class="form-control"  name="branch">
                    <option value="" selected disabled hidden>Sucursales</option>
                ...
                <div class="form-group col-md-6">
                 ...
                 <select class="form-control"  name="reader">
                     <option value="" selected disabled hidden>Verificadores</option>
